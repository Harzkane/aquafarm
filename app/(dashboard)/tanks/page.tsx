...
> = [
  {
    ...
    notes: "Main grow-out tank. Start fish here from Week 3+",
    status: "empty",
  },
  {
    ...
    type: "half-cut",
    capacity: 2500,
    targetFishCapacity: 300,
    dimensions: "Half of 5,000L tank",
    notes: "Start 300 juveniles here from Day 1",
    status: "empty",
  },
  {
    ...
    type: "half-cut",
    capacity: 1750,
    targetFishCapacity: 250,
    dimensions: "Half of 3,500L tank",
    notes: "Start 250 juveniles here from Day 1",
    status: "empty",
  },
  {
